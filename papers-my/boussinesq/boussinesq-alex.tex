...
is given by \cref{wp-def}. If well-posedness holds for $s \ge -1/2$, then for
...
\begin{lemma}
  ...
  well-posedness is given by \cref{wp-def}. Then for
...
\begin{theorem}
  ...
  \ge -1/2$, where our notion of well-posedness is given by \cref{wp-def}.
  Then for $s < -1/2$
  %
  %
    \begin{enumerate}[(I)]
