...
\begin{figure}[!h]
  ...
  \vspace{-30mm}
  \hspace{-15mm}
\subfloat{\includegraphics[scale=0.5]{c3b1}} 
\hspace{-40mm}
\subfloat{\includegraphics[scale=0.5]{c3b3}}
\\
\vspace{-70mm}
\hspace{-15mm}
\subfloat{\includegraphics[scale=0.5]{c7b3}}
\hspace{-40mm}
\subfloat{\includegraphics[scale=0.5]{c13b3}}
\end{center}
\end{figure}
...
%
%Suppose that we try to obtain solitons following a different route. Note that the analog for 
...
%%
%%
%Recalling that $y = f-r$ and $r = 4b/c^{2}$, we see that
%%
%%
%\begin{equation*}
%\begin{split}
...
%%
%%
%But $f > 0$, violating our earlier assumption.
