...
\begin{definition}
  ...
  \end{enumerate}
  For $s, b \in \rr$, $X_{s}$ denotes the completion of $\mathcal{Y}$ with
  respect to the norm
  %
  %
  \begin{equation}
  \begin{split}
    \|F\|_{X_{s}} = \left( \sum_{n \in \zz} (1 + |n|)^{2s} \int_{\rr}
    \vp_{s}(n, \tau) |\wh{F}(n, \tau)|^{2} d \tau\right)^{1/2}.
  \end{split}
  \label{eqn:bous-norm}
  \end{equation}
  %
  ...
  \begin{equation*}
  \begin{split}
    \vp_{s}(n,\tau) = \min\left\{ \langle n \rangle^{s-2}  \langle \tau^{2}  - n^{4} \rangle,   \langle n \rangle ^{-3/2} \langle \tau - n^{2} \rangle ^{1/2 + s} \langle \tau + n^{2} \rangle    \right\}.
  \end{split}
  \end{equation*}
  %
  %
...
\end{definition}
%
The $X_{s}$ spaces have the following important embedding, whose proof is
...
\begin{definition}
  ...
  $H^s \times H^{s-2}$ if 
    ...
    \item Given $(u_{0}, u_{1}) \in H^{s} \times H^{s-2}$
      ...
      \delta], H^s) \cap X_{s}$ for $ |t| \le \delta$.
...
$B_{X_{s}}(M)$ for suitably small $\delta$, where $\delta >0$ is a constant
depending on $M$ and
$M > 0$ is a constant depending on $\|\vp\|_{H^{s} \times H^{s-2}}$. First, we
will estimate the $X_{s}$ norm of
\cref{main1-rel-term-1}-\cref{main1-rel-term-5}. 
The Picard fixed point theorem
will then yield a unique $u \in X_{s}$ satisfying $u = Tu$.  An application of
\cref{lem:embedding} will then imply the existence of a unique $u \in
C([-\delta, \delta], H^s(\ci)) \cap X_{s}$ solving $\psi_{\delta} u = Tu$ for
...
\begin{align}
  & \| \cref{main1-rel-term-1} \|_{X_{s}}^{2} 
    ...
    |-n^{2} | \right)^{2} | \frac{\wh{\psi_{\delta}}(\tau - n^{2})\wh{u_{0}(n)}}{2} +
...
\begin{split}
  \int_{\rr} (1 + | \tau |)^{2} | \wh{\psi_{\delta}}(\tau) |^{2} d
  \tau
  & = \left (\frac{\delta}{2} \right )^{2} \int_{\rr} (1 + | \tau |)^{2} | \wh{\psi}(\delta \tau
  /2) |^{2} d
  \tau
  \\
  & =  \frac{\delta}{2}  \int_{\rr} (1 + | 2 \lambda /\delta |)^{2} | \wh{\psi}(\lambda) | d \lambda
  \\
  & \le \frac{\delta}{2} \int_{\rr} (1/\delta + | 2 \lambda / \delta |)^{2} | \wh{\psi}(\lambda) | d
...
$\|\cref{main1-rel-term-1}\|_{X_{s}}^{2} \le c_{\psi,b} \delta^{-1}
\|u_{0}\|_{H^s}^2$. Taking square roots of both sides gives
%
%
\begin{equation}
  \begin{split}
    \|\cref{main1-rel-term-1}\|_{X_{s}} \le c_{\psi,b} \delta^{1/2-b}
    \|u_{0}\|_{H^s}.
  \end{split}
...
\begin{align}
  & \| \cref{main1-rel-term-1} \|_{X_{s}}^{2} 
    ...
    \\
    & = \sum_{n \in \zz}(1 + |n|)^{2s} \int_{\rr}\left( 1 + | | \tau
    |-n^{2} | \right)^{2} | \frac{\wh{\psi}(\tau - n^{2})\wh{u_{0}(n)}}{2} +
...
$\|\cref{main1-rel-term-1}\|_{X_{s}}^{2} \le c_{\psi,b} 
\|u_{0}\|_{H^s}^2$. Taking square roots of both sides gives
%
%
\begin{equation}
  \begin{split}
    \|\cref{main1-rel-term-1}\|_{X_{s}} \le c_{\psi,b} 
    \|u_{0}\|_{H^s}.
  \end{split}
...
%
Therefore, 
$\|\cref{main1-rel-term-2}|_{X_{s}}^{2} \le c_{\psi,b} 
\|u_{1}\|_{H^{s-2}}^2$ and
...
\begin{equation}
  \label{u-1-est}
  \begin{split}
    \|\cref{main1-rel-term-2}|_{X_{s}} \le c_{\psi,b} 
    \|u_{1}\|_{H^{s-2}}.
  \end{split}
\end{equation}
%
...
\begin{equation}
	\label{schwartz-mult}
	\begin{split}
    \|\psi_{\delta} f \|_{X_{s}} \le c_{\psi, b} \delta^{1/2-b} \|f \|_{X_{s}}.
	\end{split}
\end{equation}
%
%
...
\begin{split}
  & \| \sum_{n \in \zz} e^{ixn} \int_\rr 
    ...
    (1 + |  |\tau| - n^{m}|)^{2} \left | \frac{1 - a\psi(\tau - an^{2 
})}{\tau - an^{m}} 
    ...
    (1 + | |\tau| - n^{m}|)^{2} \frac{|  \wh{w_{\delta}}(n, \tau)|^2}{|\tau - an^{m}|^2} 
		\ d 
		\tau \right)^{1/2}
  \end{split}
\end{equation}
...
\begin{equation}
	\begin{split}
    \|\cref{main1-rel-term-3}\|_{X_{s}} \le c_{\psi, b} 
    \|u\|^{2}_{X_{s}}.
	\end{split}
\end{equation}
%
...
\begin{equation}
  \label{iu}
    ...
    \int_\rr \left( 1 + | |\tau| - n^{m} \right )^{2} | | \wh{\psi}\left(
...
\int_\rr \left( 1 + | |\tau| - n^{m} \right )^{2} | | \wh{\psi}\left(
    ...
    \\
    & \le  \sum_{a = \pm 1} 
    \int_\rr \left( 1 + |\tau - an^{m} | \right )^{2} | | \wh{\psi}\left(
    \tau - an^{m} \right) |^2 \ d \tau 
    \\
    & = c_{\psi, b}.
\end{split}
...
%
%
Letting $b' = -(1- 2 \eta)$ and applying, we obtain the
bound
\begin{equation*}
  \begin{split}
...
\begin{equation}
  \label{main-int3-est}
	\begin{split}
    \|\cref{main1-rel-term-3}\|_{X_{s}} \le c_{\psi, b} 
    \delta^{1/2} \|u\|^{2}_{X_{s}}, \quad  b > 1/2,  \ s > -1/4.
	\end{split}
\end{equation}
...
\begin{equation}
	\label{3n}
	\begin{split}
		& \int_\rr \left( 1 + | |\tau| - an^{m} | \right)^{2} | \wh{t^{k}
		\psi_{\delta}(t)}\left( \tau - an^{m} \right) |^2 \ d \tau
    \\
    & = 2 
    \int_\rr \left( 1 + |\tau'| \right)^{2} | \wh{t^k \psi_{\delta}(t)}(\tau') |^2 \
		d \tau'
		\\
    & \lesssim
    \int_\rr \left( 1 + |\tau'| \right)^{2} | \wh{t^k \psi_{\delta}(t)}(\tau')
		|^2 \ d \tau'
		\\
    & \le \| t^{k} \psi \|_{H^{[b] +
  1}}^{2}
...
\label{main-int4-est}
	\begin{split}
    \|\cref{main1-rel-term-5}\|_{X_{s}} \le c_{\psi, b} \delta^{1/2}
    \|u\|_{X_{s}}^{3}, \quad b > 1/2, \ s > -1/4.
	\end{split}
\end{equation}
%
%
...
%
%
Hence, $T=T_{u_0, u_1, \psi, \delta}$ maps the ball $B_{X_{s}}(2rc)$ into
...
\begin{equation}
	...
	\begin{split}
		\|Tu - Tv \|_{X_{s}}  
    & \le c \delta^{b - 1/2}\|u -v\|_{X_{s}} \|u + v \|_{X_{s}}
		\\
    & \le c \delta^{b -1/2} \|u -v\|_{X_{s}} (\|u\|_{X_{s}}+ \|v \|_{X_{s}}).
	\end{split}
\end{equation}
%
%%
If $$ u, v \in B_{X_{s}} \left (2rc \right )$$ then choosing $\delta$ as in
...
\begin{equation}
	...
	\begin{split}
		\|Tu - Tv \|_{X_{s}}
    & \le c \delta^{b-1/2} \|u -v \|_{X_{s}} \left( 2rc + 
		2rc \right)
		\\
		& = \frac{1}{2} \|u -v \|_{X_{s}}. 
	\end{split}
...
%
%%
We conclude that $T$ is a contraction on the ball $B_{X_{s}}(2rc)$.
A Picard iteration then yields a unique 
$u \in X_{s}$ satisfying $u = Tu$. Applying
\cref{lem:embedding}, it follows that $u(x,t) \subset C( [-\delta, \delta], H^s)
\cap X_{s}$ is a unique
...
\begin{equation}
	\label{gen-2a}
	\begin{split}
    & \| \cref{main1-rel-term-1g}\|_{X_{s}}
		\le c \|u_0 -v_0\|_{H^s},
    \\
    & \| \cref{main1-rel-term-2g}\|_{X_{s}}
...
\begin{equation*}
	\begin{split}
    \|u -v \|_{X_{s}}
    & = \|T_{u_0, v_0}(u) - T_{u_1, v_1}(v) \|_{X_{s}}
    \\
    & \le
...
\begin{equation}
	\begin{split}
		\|u -v \|_{X_{s}} \le 2 c \left( \|u_0 -v_0 \|_{H^s\left( \ci \right)} +\|u_1 -v_1
        \|_{H^{s-2}\left( \ci \right)} \right ).
	\end{split}
...
\begin{equation}
	...
	\begin{split}
	|	\sum_{n}  (1 + |n|)^{s}
		\int_{\rr} \phi(n, \tau) \wh{uv}(n, \tau) d \tau | \lesssim \|u\|_{X_{s}}
    \|v\|_{X_{s}}
    \|\phi \|_{L^{2}_{n, \tau}}.
	\end{split}
\end{equation}
...
\begin{equation}
	\label{10g}
	\begin{split}
    & \sum_{n} \int_{\tau} \phi(n, \tau) \langle n \rangle ^{s}
    \\
...
\begin{equation*}
  ...
  c_{v}^{2} (n - n_1, \tau - \tau_{1} ) d \tau_1  \right)^{1/2} \|_{L^{2}(\zz \times
    ...
    \rangle^{2} \langle  |\tau -
    \tau_{1} | -(n - n_{1})^{2}
    \rangle^{2}} d \tau_1 \right)^{1/2} \|_{L^2(\zz \times \rr)}
		\\
...
n-n_{1} \rangle ^{2s} \langle | \tau_{1}|-n_{1}^{2} \rangle^{2} \langle  |\tau -
    \tau_{1} | -(n - n_{1})^{2}
    \rangle^{2}} d \tau_1 \right)^{1/2} \|_{L^\infty_{n, \tau}}
	\end{split}
\end{equation}
%
%
...
\begin{equation*}
  ...
  c_f(n_1, \tau - \lambda)
		...
		\\
    & \times \frac{\langle n \rangle ^{s}}{\langle n_{1} \rangle ^{s} \langle
    n-n_{1} \rangle ^{s}} \times \frac{1}{\langle |\tau - \lambda|-n_{1}^{2} \rangle\langle |
    \lambda|-(n - n_{1})^{2}
    \rangle} d \lambda  d \tau
	\end{split}
\end{equation*}
where 
%
...
\begin{equation*}
  ...
  c_{v}^{2} (n - n_1, \lambda ) d \tau_1  \right)^{1/2} \|_{L^{2}(\zz \times
    ...
    \rangle} d \tau_1 \right)^{1/2} \|_{L^2(\zz \times \rr)}
		\\
    & = \|u\|_{X_{s}} \|v\|_{X_{s}} \label{holder-term-0}
...
\begin{split}
  ...
  \int_{\tau_{1}} \chi_{A} \phi(n, \tau)
    ...
    \langle |\tau_{1}|-n_{1}^{2} \rangle\langle | \tau|-n_{2}^{2}
    \rangle} d \tau_1 d \tau 
   \end{split}
\end{equation*}
...
\begin{equation}
  ...
  \begin{split}
    ...
    n-n_{1} \rangle ^{2s} \langle | \tau_{1}|-n_{1}^{2} \rangle^{2}  \langle  |\tau -
    \tau_{1} | -(n - n_{1})^{2}
    \rangle^{2}} d \tau_1  \|_{L^\infty_{n, \tau}} < \infty.
  \end{split}
\end{equation}
%
or
...
\begin{split}
  ...
  } \sum_{n} \int_{\tau} \frac{\langle n \rangle ^{2s}}{\langle
...
n-n_{1} \rangle ^{2s}  \langle | \tau - \lambda|-n_{1}^{2}
\rangle^{2} \langle  | \lambda | -(n - n_{1})^{2}
\rangle^{2}} d \tau  \|_{L^{\infty}_{n, \lambda}}
\end{split}
\end{equation}
%
%
...
\begin{equation}
  ...
  \begin{split}
    ...
    \langle \sigma_{1} \rangle^{2} \langle  \sigma_{2} \rangle^{2}}
...
\begin{split}
  ...
  \sigma \rangle^{2}  \langle \sigma_{2} \rangle^{2}} d \tau 
...
\begin{split}
  \| \sum_{n_{1}} \int_{\tau} \frac{\chi^{*}_{A_{j}}
    ...
    n-n_{1} \rangle ^{2s} 
    \langle \sigma_{1}^{*} \rangle^{2}
    \langle  \sigma_{2}^{*} \rangle^{2}} d \tau  \|_{L^{\infty}_{n, \lambda}}
\end{split}
\end{equation}
%
%
...
\begin{split}
  ...
  ^{2s} \langle n - n_{1} \rangle ^{2s}  \langle
  \tau - \lambda +  n_{1}^{2} \rangle^{2}
   \langle \lambda - (n - n_{1})^{2} \rangle^{2}} d \tau
\end{split}
\end{equation*}
%
%
...
\begin{split}
  ...
  ^{4s}  \langle \tau - \lambda + n_{1}^{2} \rangle^{2}
   \langle \lambda  - n_{1}^{2} \rangle^{2}} d \tau
\end{split}
\end{equation*}
By a change of variable, this is bounded by
%
\begin{equation*}
\begin{split}
  & c\sum_{n_{1}} \frac{\chi^{*}_{A_{1}}}{\langle n_{1} \rangle ^{4s} \langle
  \lambda- n_{1}^{2} \rangle^{2}  }
  \\
  & \lesssim \sum_{n_{1}}  \frac{\chi_{A_{1}}^{*}}{\langle n_{1} \rangle^{4(s-4)}}
  \\
  & < \infty, \qquad s > -3/4.
\end{split}
\end{equation*}
...
%
\begin{framed}
Other splittings give us worse results. To see this, we'd like to bound
\begin{equation*}
\begin{split}
  & \frac{1}{\langle n_{1} \rangle ^{2s}
  } \sum_{n} \int_{\tau} \frac{\langle n \rangle ^{2s}}{\langle
  n - n_{1}\rangle ^{2s}}  \times \frac{\chi_{A_{1}}}{\langle
  \tau - n^{2}  \rangle^{2}  \langle \tau - \tau_{1} - (n - n_{1})^{2}
  \rangle^{2}} d \tau 
\end{split}
\end{equation*}
which is equal to 
...
\begin{split}
  ...
  } \int_{\tau} \frac{1}{\langle
  \tau  \rangle^{2}  \langle \tau - \tau_{1} - n_{1}^{2}
  \rangle^{2}} d \tau.
\end{split}
\end{equation}
%
...
\end{lemma}
%
By \cref{lem:calc} and \cref{lem:calc-lower-bound}, \cref{case-1-term-1-reduc} is bounded by
%
%
\begin{equation*}
\begin{split}
  & \frac{c}{\langle n_{1} \rangle ^{4s} 
  \langle \tau_{1} + n_{1}^{2} \rangle^{2}
} \lesssim
\frac{1}{\langle n_{1} \rangle ^{4s}} < \infty, \quad s \ge 0.
\end{split}
\end{equation*}
%
%
...
%
%
Suppose instead we tried to estimate
%
%
\begin{equation*}
  \begin{split}
...
d \tau_1 
\\
  & \lesssim   \langle \tau - n^{2} \rangle ^{-2} 
  \\
  & < \infty.
	\end{split}
\end{equation}
%
%
For the region $ A_{4}$, we apply \cref{lem:calc} 
to obtain
%
%
%
...
&  \langle n
    \rangle ^{2s}
    \sum_{n_{1}} \int_{\tau_{1}} \frac{\chi_{A_{4}}}{\langle n_{1} \rangle ^{2s} \langle n-n_{1} \rangle ^{2s} 
\langle \tau_{1} - n_{1}^{2}  \rangle^{2} \langle  \tau - \tau_{1} - (n -
n_{1})^{2}  \rangle^{2}}
d \tau_1 
\\
& \lesssim  \langle n \rangle ^{2s}
\sum_{n_{1} \in
\zz}  \frac{\chi_{A_{4}}}{\langle n_{1} \rangle ^{2s} \langle n - n_{1} \rangle
^{2s} \langle \tau - n^{2} - 2n_{1}^{2} + 2nn_{1}  \rangle^{2}}
\\
& \lesssim 
\sum_{n_{1} \in
\zz}  \frac{\langle n_1 \rangle ^{-2s} \langle n - n_{1} \rangle ^{-2s}}{\langle
n \rangle ^{-2s} } \times \frac{\chi_{A_{4}}}{\langle \tau - n^{2} - 2n_{1}^{2} + 2nn_{1}
\rangle^{2}}.
\end{split}
\end{equation}
%
...
\sum_{n_{1} \in
\zz} 
\frac{n_{1}^{\gamma(s)}}{\langle \tau - n^{2} - 2n_{1}^{2} + 2nn_{1}  \rangle^{2}}
\end{split}
\end{equation*}
%
%
%
which is finite for $s > -3/4$, due to the following lemma, whose proof can be found in
the
appendix.
\begin{lemma}
  \label{lem:sum-estimate}
If $2 \alpha - 4 \gamma(s)>1$, then
\begin{equation}\label{CI2}
\sup_{(n,\tau)\in \zz \times \rr}\sum_{n_1\in \zz}\frac{\langle n_{1} \rangle ^{\gamma(s)}}{(1+|\tau\pm
n_1(n-n_1)|)^{\alpha}}<\infty. 
\end{equation}
\end{lemma}
%
%
\begin{framed}
For other splittings, we do worse. For example
\begin{equation}
  \label{region-4-2}
\begin{split}
  &  \frac{1}{\langle n_{1} \rangle ^{2s}
  } \sum_{n} \int_{\tau} \frac{\langle n \rangle ^{2s}}{\langle
  n - n_{1}\rangle ^{2s}}  \times \frac{\chi_{A_{4}}}{\langle
...
%
Applying
\cref{lem:calc} gives the bound
%
%
\begin{equation*}
\begin{split}
&  \frac{c}{\langle n_{1} \rangle ^{2s}
  } \sum_{n} \frac{\langle n \rangle ^{2s}}{\langle
  n - n_{1}\rangle ^{2s}}  \times \frac{\chi_{A_{4,2}}}{\langle
  \tau_{1} - 2nn_{1} + n_{1}^{2} \rangle^{2}} 
  \\
  & \lesssim 
  \sum_{n} \frac{n_{1}^{\gamma(s)}}{\langle
  \tau_{1} - 2nn_{1} + n_{1}^{2} \rangle^{2}}.
  \end{split}
\end{equation*}
%
%
Just take $\tau_{1} = -n_{1}^{2}$.
\end{framed}
...
\begin{split}
  \sum_{n_{1}} \int_{\tau} \frac{\chi^{*}_{B_{3}}
    ...
    n-n_{1} \rangle ^{2s} 
    \langle \tau - \lambda + n_{1}^{2} \rangle^{2}
    \langle  \lambda + n_{1}^{2} \rangle^{2}} d \tau  
\end{split}
\end{equation*}
which is bounded by 
...
\begin{split}
  \sum_{n_{1}} \frac{c}
  {\langle n_{1} \rangle^{4s} 
  \langle n_{1}^{2} + \lambda \rangle^{2}
   } d \tau.
\end{split}
\end{equation*}
%
%
Applying \cref{lem:calc-lower-bound}, this is bounded by
\begin{equation*}
\begin{split}
  & \sum_{n_{1}} \frac{c}
  {\langle n_{1} \rangle ^{4(s+1)}} 
  \\
  & < \infty, \qquad s > -3/4.
\end{split}
\end{equation*}
...
\begin{split}
   \sum_{n_{1}} \langle
   n_{1}\rangle ^{-4s} \int_{\tau_{1}} \frac{\chi_{B_{1}}}{\langle \tau_{1} + n_{1}^{2} \rangle^{2} \langle
  \tau - \tau_{1} - n_{1}^{2}\rangle^{2}}d \tau_{1}.
\end{split}
\end{equation}
...
\begin{split}
  c  \langle \tau \rangle
  ^{-2} \sum_{n_{1}} \langle n_{1} \rangle
  ^{-4s} 
...
\begin{split}
   \sum_{n_{1}} \langle
   & n_{1}\rangle ^{-4s} \int_{\tau_{1}} \frac{1}{\langle \tau_{1} + n_{1}^{2} \rangle^{2} \langle
   \tau_{1} + n_{1}^{2}\rangle^{2}}d \tau_{1} 
   \\
   & = \sum_{n_{1}} \langle
  n_{1}\rangle ^{-4s} \int_{\tau'} \frac{1}{\langle
   \tau' \rangle ^{4b}}d \tau'
...
n \rangle ^{-2s} } \times \frac{\chi_{B_{3,1}}}{\langle \tau - n^{2} - 2n_{1}^{2} + 2nn_{1}
\rangle^{2}}.
\end{split}
\end{equation}
%
...
\begin{equation*}
\begin{split}
  \sum_{n_{1}}   \frac{n_{1}^{\gamma(s)}}{\langle \tau - n^{2} - 2n_{1}^{2} + 2nn_{1}
\rangle^{2}}
\end{split}
\end{equation*}
%
...
%
%
which is finite for $s > -3/4$, due to \cref{lem:sum-estimate}. 
...
\begin{definition}
  ...
  $\rr^{2}$.  For $s, b \in \rr$, $\mathcal{X}_{s}$
  ...
  \begin{equation}
  \begin{split}
    \|F\|_{\mathcal{X}_{s}} = \left( \int_{\rr} \int_{\rr} (1 + \xi^{2})^{s}
...
If $b > 1/2$, $a > 1/4$, and $s \ge -a/2$, 
  ...
  \begin{equation*}
  \begin{split}
    \| uv \|_{\mathcal{X}_{s,-a}} \le c \| u \|_{\mathcal{X}_{s}} \| v \|_{\mathcal{X}_{s}}.
  \end{split}
  \end{equation*}
  %
  %
...
\begin{equation}
    ...
    + | |\tau| - \xi^{2} |^{-a}) d \tau d \xi | \lesssim \|u\|_{\mathcal{X}_{s}}
    \|v\|_{\mathcal{X}_{s}}
    \|\phi \|_{L^{2}_{\xi, \tau}}.
	\end{split}
\end{equation}
...
\right)}{\langle \xi_1 \rangle ^s \langle |\tau_1| - \xi_1^{2} | \rangle}
\\
& \times \frac{c_{v}\left( \xi - \xi_1, \tau - \tau_1 \right)}{\langle \xi -
\xi_1 \rangle ^s\ \langle |\tau - \tau_1 | -  (\xi - \xi_1)^{2} \rangle}
\ d \tau_1 d \xi_{1}
\end{split}
\end{equation}
%
...
\begin{equation*}
	\begin{split}
		c_h(\xi, \tau) =
			\langle \xi \rangle ^s \langle |\tau| - \xi^{2} \rangle | \wh{h}\left( \xi, \tau \right) |.
	\end{split}
\end{equation*}
%
%
...
\begin{equation}
    ...
    \langle \xi - \xi_1 \rangle^s} 
		\times \frac{c_f(\xi_1, \tau_1)}{\langle |\tau_1| - \xi_1^{2} \rangle}
		\\
		& \times
		\frac{c_g(\xi - \xi_1, \tau - \tau_1 )}{\langle |\tau - \tau_1| - (\xi - \xi_1)^{2}
    \rangle}\ d \tau_1 d \xi_{1}.
	\end{split}
\end{equation}
%
%
...
\begin{equation}
  ...
  \begin{split}
     \| \langle \xi
     \rangle ^{2s}\int_{\xi_{1}}
     \int_{\tau_{1}} \frac{\chi_{A_{j}}}{\langle \xi_{1} \rangle ^{2s} \langle
\xi-\xi_{1} \rangle ^{2s}
\langle | \tau_{1}|-\xi_{1}^{2} \rangle^{2}  \langle  |\tau -
    \tau_{1} | -(\xi - \xi_{1})^{2}
    \rangle^{2}} d \tau_1 d \xi_{1} \|_{L^\infty_{\xi, \tau}} < \infty.
  \end{split}
\end{equation}
%
or
...
\begin{split}
  ...
  } \int_{\xi} \int_{\tau} \frac{\langle \xi \rangle ^{2s}}{\langle
  \xi - \xi_{1}\rangle ^{2s}}  \times \frac{\chi_{A_{j}}}{\langle | \tau | - \xi^{2} \rangle^{2}  \langle | \tau -
  \tau_{1} | - (\xi - \xi_{1}^{2}) \rangle^{2}} d \tau d \xi
...
\rangle^{2} \langle  | \lambda | -(\xi - \xi_{1})^{2}
\rangle^{2}} d \tau d \xi_{1} \|_{L^{\infty}_{\xi, \lambda}} < \infty
\end{split}
\end{equation}
%
%
...
\begin{split}
  ...
  \sigma \rangle^{2}  \langle \sigma_{2} \rangle^{2}} d \tau d \xi
  \|_{L^{\infty}_{\xi_{1}, \tau_{1}}} < \infty
\end{split}
\end{equation}
%
...
\begin{split}
  \| \int_{\xi_{1}}  \int_{\tau} \frac{\chi^{*}_{A_{j}}
    ...
    \xi-\xi_{1} \rangle ^{2s}     \langle \sigma_{1}^{*} \rangle^{2}
    \langle  \sigma_{2}^{*} \rangle^{2}} d \tau d \xi_{1}  \|_{L^{\infty}_{\xi, \lambda}}
    < \infty
\end{split}
\end{equation}
%
...
\begin{equation}
  ...
  \begin{split}
    ...
    \langle \tau_{1} - \xi_{1}^{2} \rangle^{2} \langle  \tau - \tau_{1} -
    (\xi - \xi_{1})^{2} \rangle^{2}}
    d \tau_1 d \xi_{1}.
  \end{split}
\end{equation}
...
\begin{split}
    ...
    \xi_{1}^{2} \rangle^{2} \langle  \tau - \tau_{1} - (\xi - \xi_{1})^{2}
    \rangle^{2}} d \tau_1 d \xi_{1}.
\end{split}
\end{equation*}
%
%
...
\begin{split}
  ...
  \xi_{1}^{2} \rangle^{2}} d \xi_{1}
  \\
  & \le c_{1} \int_{\xi_{1}}
  \frac{\chi_{A_{1}}}{\langle \tau - \xi^{2} + 2 \xi \xi_{1} - 2
  \xi_{1}^{2} \rangle^{2}} d \xi_{1}, \quad a > 0
  \\
& < c, \quad b > 1/4
\end{split}
\end{equation}
...
\begin{split}
  ...
  \xi - \xi_{1}\rangle ^{2s}}  \times \frac{\chi_{A_{3}}}{\langle
  \tau_{1} + 2 \xi \xi_{1} - \xi_{1}^{2} \rangle^{2}} d \xi.
\end{split}
\end{equation}
%
...
\begin{equation*}
\begin{split}
  &  \int_{\xi} \frac{\chi_{A_{2,2}} \langle \xi_{1} \rangle ^{\gamma(s)}}{\langle
  \tau_{1} + 2 \xi \xi_{1} - \xi_{1}^{2} \rangle^{2}} d \xi
\end{split}
\end{equation*}
%
...
\begin{equation*}
\begin{split}
  & \frac{1}{2} \langle \xi_{1} \rangle ^{\gamma(s)}  \int_{\eta} 
  \frac{1}{| \xi_{1} |}d \eta
  \\
...
\begin{split}
  ...
  \int_{\tau_{1}}
  \frac{\chi_{A_{1}}}{\langle \tau_{1} + \xi_{1}^{2} \rangle^{2}  \langle \tau
  - \tau_{1} - ( \xi - \xi_{1})^{2}\rangle^{2}} d \tau_{1} d \xi_{1}.
\end{split}
\end{equation*}
%
%
...
\begin{split}
  \frac{1}{\langle \tau - \xi^{2} \rangle ^{2a}} \int_{\xi_{1}}
  \frac{\chi_{A_{1}}}{\langle \tau - \xi^{2} + 2 \xi \xi_{1} \rangle^{2}} d
  \xi_{1}.
\end{split}
...
\begin{equation*}
  \begin{split}
    ...
    \langle \tau - \xi^{2} +2 \xi \xi_{1} \rangle^{2}} d \xi_{1}.
  \end{split}
\end{equation*}
%
%
...
\begin{split}
  &  c
  \int_{\xi} \frac{\chi_{A_{3,2}} \langle \xi_{1} \rangle ^{\gamma(s)}}{\langle
  \tau_{1} + 2 \xi \xi_{1} - \xi_{1}^{2} \rangle^{2}} d \xi
\end{split}
\end{equation*}
which by the change of variable
...
\begin{equation*}
\begin{split}
  & \frac{c \xi_{1}^{\gamma(s)}}{2}  \int_{\eta} 
  \frac{1}{| \xi_{1} |\langle \eta \rangle ^{2a}}d \eta
  \\
  & = c\langle \xi_{1} \rangle ^{\gamma(s) -1} \int_{0}^{\infty} \frac{1}{(1 + \eta
  )^{2a}}d \eta
  \\
  & \lesssim 1, \qquad s \ge -\frac{2a+1}{4}.
\end{split}
...
%
%
Then we let $A_{n}: H^{s} \times H^{s-2} \to X_{s}, \ n = 1, 2, \dots$ be the
...
\begin{proposition}
  ...
  H^{s-2}$ to a ball $B_{X_{s}}$ in $X_{s}$. Suppose that the solution map
  is continuous from $B_{H^{s'} \times
  H^{s'-2}}$ to $(B_{X_{s}}, \| \|_{X_{s', b}})$ (i.e.\ the
  ball $B_{X_{s}}$ equipped with the $X_{s',b}$ topology),
...
\begin{remark}
  ...
  functions $u,v \in X_{s}$, one has the estimates
\begin{enumerate}
  \item{$\|L(f)\|_{X_{s}} \le C \| f \|_{H^s \times H^{s-2}}$}
  \item{$\| N(u, v) \|_{X_{s}} \le C \delta^{b - 1/2} \| u \|_{X_{s}} \| v \|_{X_{s}}$} 
\end{enumerate}
...
\begin{enumerate}[(I)]
  \item
    ...
    $u[f] \in X_{s} \cap C([-\delta, \delta], H^{s})$
...
\begin{equation}
  \label{induct-ineq}
  \begin{split}
    \| A_{n}(f) \|_{X_{s}} \le  c_{\psi}^{2n-1} 30^{(n-1)}
    \delta^{(n-1)(b-1/2)} \| f
    \|_{H^{s} \times H^{s-2}}^{n}
  \end{split}
  \end{equation}
...
(in $X_{s}$) power series expansion
%
%
\begin{equation}
...
$B_{X_{s}}(r_{2})$. Let $\left\{ f_{m} \right\} \subset B_{H^{s} \times
...
$(H^{s} \times H^{s-2}, \|  \|_{H^{s'} \times H^{s'-2}})$ to $(X_{s}, \|
\|_{X_{s',b}})$. Then
%
%
\begin{equation*}
...
\begin{proof}[Proof of \cref{qwp-it-1}]
  ...
  \begin{align}
    \label{ill-pos-lin}
    & \| L(f) \|_{X_{s}} \le c_{\psi} \| f \|_{H^{s} \times H^{s-2}},
    \\
    & \| N(u,v) \|_{X_{s}} \le c_{\psi} \delta^{b-1/2} \| u \|_{X_{s}} \| v
    \|_{X_{s}}.
    \label{ill-pos-bil}
  \end{align}
  %
...
\begin{equation*}
\begin{split}
  \|A_{n}(f) - A_{n}(g)  \|_{X_{s}} = \| \sum_{\substack{j,
  k \in \mathbb{N} \\ j + k =n}}\left\{ N\left[
  A_{j}(f), A_{k}(f) \right] - N\left[
  A_{j}(g), A_{k}(g) \right]  \right\} \|_{X_{s}}.
\end{split}
\end{equation*}
%
%
...
A_{k}(f), A_{j}(g) \right] \right \}  \|_{X_{s}}
\\
& = \| \sum_{\substack{j,
...
\begin{split}
  ...
  A_{j}(g) \|_{X_{s}} \| A_{k}(f) +
  A_{k}(g) \|_{X_{s}}
  \\
  & \le c_{\psi} \delta^{b-1/2}\sum_{\substack{j,
  k \in \mathbb{N} \\ j + k =n}} \| A_{j}(f) -
  A_{j}(g) \|_{X_{s}} ( \| A_{k}(f) \|_{X_{s}} +
  \| A_{k}(g) \|_{X_{s}} )
\end{split}
\end{equation*}
%
...
\sum_{n=1}^{k}A_{n}(f)$ is absolutely convergent in $X_{s}$ (and hence
converges in $X_{s}$ to an element of $X_{s}$). Applying \cref{induct-ineq} and
  \cref{delta-ill-pos} to obtain 
  %
  %
  \begin{equation*}
  \begin{split}
    \sum_{n=1}^{\infty} \| A_{n}(f) \|_{X_{s}}
    & \le \sum_{n=1}^{\infty}
       c_{\psi}^{2n-1} 30^{(n-1)}
    \delta^{(n-1)(b-1/2)} \| f
    \|_{H^{s} \times H^{s-2}}^{n}
  ...
  solution $u[f] \in X_{s} \cap C([-\delta, \delta], H^{s})$ to the integral
  equation $Tu = u$; that is $L(f) + N(u,u) -u =0$. Since $u_{k}$ is convergent
  in $X_{s}$, It remains to show that
  $u_{k}$ converges to this $u$ in $X_{s}$. 
Using this as motivation, we will now estimate the error of $u_{k} \doteq
  ...
  \begin{equation*}
  \begin{split}
    & \|L(f) + N(u_{k}, u_{k}) - u_{k}\|_{X_{s}}
    \\
    &= \|
    \sum_{k < i+j \le 2k} N\left[ A_{i}(f), A_{j}(f) \right]\|_{X_{s}}
    \\
...
\begin{equation}
  ...
  \begin{split}
    & c_{\psi} \delta^{b-1/2}
    \sum_{k < i+j \le 2k} \| A_{i}(f) \|_{X_{s}} \| A_{j}(f)
    \|_{X_{s}}
    \\
...
%
%
Therefore, using the definition of the $X_{s}$ spaces, and applying
...
\begin{split}
  ...
  | \tau | - n^{2} |)^{2} | -\wh{w_{1}}(n, \tau - n^{2}) + \wh{w_{2}}(n, \tau +
  n^{2}) |^{2} d \tau
  \\
  & \le 4 \sum_{n \in \zz} (1 + |n|)^{2s} \int_{\rr} (1 + |
  | \tau | - n^{2} |)^{2} | \wh{w_{1}}(n, \tau - n^{2}) d \tau
  \\
  & + 4 \sum_{n \in \zz} (1 + |n|)^{2s} \int_{\rr} (1 + |
  | \tau | - n^{2} |)^{2} | \wh{w_{2}}(n, \tau + n^{2}) d \tau.
\end{split}
\end{equation*}
%
%
...
\begin{split}
  \| f \|_{X_{s}}^{2}
  & \le 4 \sum_{n \in \zz} (1 + |n|)^{2s} \int_{\rr} (1 + |
  | \tau + n^{2} | - n^{2} |)^{2} | \wh{w_{1}}(n, \tau) |^2 d \tau
  \\
  & + 4 \sum_{n \in \zz} (1 + |n|)^{2s} \int_{\rr} (1 + |
  | \tau - n^{2} | - n^{2} |)^{2} | \wh{w_{2}}(n, \tau )|^2 d \tau.
\end{split}
...
\begin{equation}
\begin{split}
  \|\psi_{\delta}(t) \int_{0}^{t} S_{t-t'} (u^{2})_{xx} dt'\|_{X_{s}} \le
...
\begin{equation}
    ...
    n^{m} | \right)^{2} | \int_\rr \wh{\psi}(\tau_1) \wh{f}\left( n, \tau -
		\tau_1
		...
		n^{m}
		|
    \right)^{2} \left( \int_\rr |\wh{\psi}\left( \tau_1 \right) | |\wh{f}\left( n,
		\tau - \tau_1
...
\begin{equation}
    ...
    \left( 1 + | \tau_{1} | \right)^{2} | \wh{\psi}(\tau_1) |^2 \left( 1 + |
		\tau - \tau_1 - n^{m} |
    \right)^{2} | \wh{f}\left( n, \tau - \tau_1 \right) |^2 d \tau 
...
\begin{equation}
  \label{uh}
    ...
    \int_\rr \left( 1 + | \tau_1 | \right)^{2} | \wh{\psi}\left( \tau_1
    \right) |^2 \left( 1 + | \lambda - n^{m} | \right)^{2} | \wh{f} \left( n,
		\lambda
...
\begin{equation*}
  \begin{split}
    ...
    \left( 1 + | \lambda - n^{m} | \right)^{2} | \wh{f}\left( n, \lambda
    \right) |^2 d \lambda
    \right]^{1/2} \right)^{2} \right)^{1/2}
    \\
    & = c_{\psi} \delta^{-b} \|f\|_{X_{s}}
	\end{split}
\end{equation*}
%
concluding the proof. 
...
We assume without loss of generality that $s < 0$. Let $\alpha = \alpha(n, \mu), \beta = \beta(n, \mu)$ be roots of the equation
%
%
\begin{equation*}
\begin{split}
...
\begin{equation*}
\begin{split}
  \sup_{(n,\tau)\in \zz \times \rr}\sum_{n_1\in \zz}\frac{\langle n_{1} \rangle^{\gamma(s)}}{(1+|\tau-
n_1(n-n_1)|)^{\gamma}}
& = \sup_{(\alpha, \beta )\in \mathbb{C}^{2}}\sum_{n_1\in \zz}\frac{\langle n_{1} \rangle^{\gamma(s)}}{(1 +
