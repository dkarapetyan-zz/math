...
\end{equation*}
%
We now need the following, whose proof is provided in the appendix.
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\label{prop:bilin-est}
  Let $s > 1/4$ and $u,v \in X_{s, -a}$. If $b > 1$, and $1/4 < a< 1/2$ 
...
Analogously to the periodic case, it will be enough
to show that 
%
%
%
...
\begin{equation}
  ...
  \begin{split}
    ...
    \rangle ^{2s}
    \int_{\rr} \int_{\rr} \frac{1}{ \langle \xi_{1} \rangle ^{2s} \langle
