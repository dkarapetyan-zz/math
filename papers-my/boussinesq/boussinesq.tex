...
\zzdot \times \zz.$$ From \cref{integral-bound-1st-form-per},
...
\end{enumerate}
%
for \cref{sup-est-gen-per-1} and \cref{sup-est-gen-per-2}. 
%
%
\begin{framed}
\begin{remark}
