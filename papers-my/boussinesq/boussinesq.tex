...
%
%
\section{Ill-Posedness for $s < -1/2$ on the Circle} 
...
\begin{split}
  ...
  & = \sup_{0 \le t \le \delta} \| \psi_{\delta}(t) (1 + | n |)^{s}
  \frac{1}{4 i \pi} \int_{0}^{t} \left( e^{in^{2}(t-t')} - e^{-in^{2}(t-t')} \right)
  \wh{(N[A_{1}(f_{N}, g_{N}), A_{2}(f_{N}, g_{N}})] )^{2}(n, t') dt' \|_{\ell^{2}_{n}}
  \\
  & = \sup_{0 \le t \le \delta} \| (1 + | n |)^{s} \frac{1}{4 i \pi} 
  \int_{0}^{t} \sum_{n_{1}} \left( e^{in^{2}(t-t')} - e^{-in^{2}(t-t')} \right)
  \wh{L(f_{N},g_{N})}(n - n_{1}, t')\wh{A_{2}(f_{N},g_{N})}(n_{1}, t') dt'
  \|_{\ell^{2}_{n}}
  \\
  & = \sup_{0 \le t \le \delta} \| (1 + | n |)^{s} \frac{1}{4 i \pi} 
  \int_{0}^{t} \sum_{n_{1}} \left( e^{in^{2}(t-t')} - e^{-in^{2}(t-t')} \right)
...
\begin{equation*}
\begin{split}
& \frac{1}{64} r^{3} N^{-3s - 3 \ee -2} 
| \int_{0}^{N^{-\alpha}} \sin(N^{-\alpha} - t')
\left[1 -\cos(N^{2}t')  \right] dt' |
\end{split}
\end{equation*}
%
%
