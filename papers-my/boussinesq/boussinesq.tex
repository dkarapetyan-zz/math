...
\end{align*} 
%
Region $A_{1}$ is easy; everything vanishes.
%
%
...
\begin{split}
  ...
  \\
&  \lesssim \sum_{n} \frac{\langle n - n_{1} \rangle ^{-2s} \langle n_{1} \rangle ^{-2s}}{\langle
    n\rangle ^{-2s}}  \times \frac{\chi_{A_{4,2}}}{\langle
...
\begin{split}
  & \sup_{n_{1}, \tau_{1}}
\sum_{n} \frac{\langle n - n_{1} \rangle ^{-2s} \langle n_{1} \rangle ^{-2s}}{\langle
    n\rangle ^{-2s}}  \times \frac{\chi_{A_{4,2}}}{\langle
  \tau_{1} - 2nn_{1} + n_{1}^{2} \rangle^{2}} 
  \\
  & = \sup_{c, n_{1}}\sum_{n} \frac{\langle n - n_{1} \rangle ^{-2s} \langle n_{1} \rangle ^{-2s}}{\langle
    n\rangle ^{-2s}}  \times \frac{\chi_{A_{4,2}}}{\langle
      cn_{1}^{2} - 2nn_{1}  \rangle^{2}} 
      \\
      & \sim \sup_{c, n_{1}} \sum_{n} \frac{\langle n - n_{1} \rangle ^{-2s} \langle n_{1} \rangle ^{-2s -2}}{\langle
    n\rangle ^{-2s}}  \times \frac{\chi_{A_{4,2}}}{\langle
      cn_{1} - 2n \rangle^{2}} 
\end{split}
\end{equation*}
...
\end{split}
  ...
  \begin{equation*}
  \begin{split}
    \sup_{c, n_{1}} \sum_{n} \frac{\langle n_{1}\rangle ^{\gamma(s)-2}}{\langle cn_{1} - 2n \rangle^{2}} < \infty, \quad s \ge -1/2
  \end{split}
  \end{equation*}
  %
  %
...
%
%
Everything in region $B_{1}$ vanishes.
Applying \cref{lem:calc}, we now bound 
\begin{equation*}
  \begin{split}
    & \langle n
...
&  \langle n
    \rangle ^{2s}
    \sum_{n_{1}} \int_{\tau_{1}} \frac{\chi_{B_{3}}}{\langle n_{1} \rangle ^{2s} \langle n-n_{1} \rangle ^{2s} 
...
\sum_{n_{1} \in
\zz}  \frac{\chi_{B_{3}}}{\langle n_{1} \rangle ^{2s} \langle n - n_{1} \rangle
^{2s} \langle \tau - n^{2} -  2nn_{1}  \rangle^{2}}.
\end{split}
\end{equation}
%
which is bounded for $s > -1/2$ (the proof of is analogous to that used to obtain boundedness for region $A_{4}$, starting at \eqref{region-4-2}).
%
%
%
%
...
%
%
\begin{proof}[Proof of Kenig Sum Estimate]
