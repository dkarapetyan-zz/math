...
\begin{equation}
  ...
  \begin{split}
		& 4 \left( \sum_{n \in 
		\zzdot} \left (1 + |n| \right )^{2s} \int_\rr
    | \wh{w}(n, \tau) |^2 
		 \ d \tau 
		\right)^{1/2}.
\end{split}
...
\begin{equation}
  \label{iu}
    ...
    \int_\rr \left( 1 + | |\tau| - \gamma(n) \right )^{2} | | \wh{\psi}\left(
...
\int_\rr \left( 1 + | |\tau| - \gamma(n) \right )^{2} | | \wh{\psi}\left(
    ...
    \\
    & \le  \sum_{a = \pm 1} 
    \int_\rr \left( 1 + |\tau - a\gamma(n) | \right )^{2} | | \wh{\psi}\left(
    \tau - a\gamma(n) \right) |^2 \ d \tau 
    \\
    & = c_{\psi}.
\end{split}
...
\begin{equation}
	...
	\begin{split}
	  &  \sup_{\|a_{n}\|_{\dot{\ell}^{2}}=1}| \sum_{n \in \zzdot} \left (1 + |n| \right )^{s} a_n
		...
		\\
		& \le \sup_{\|a_{n}\|_{\dot{\ell}^{2}}=1} \left( \sum_{n \in \zzdot} | a_{n} |^2\int_{\rr} \frac{1}{\left( 1 + | |\lambda| - \gamma(n) | \right)^{2}} \ d \lambda  
		\right)^{1/2} 
		\left ( \sum_{n \in \zzdot}\int_{\rr} \left (1 + |n| \right )^{2s} | \wh{w}(n, \lambda) 
		|^2\ d \lambda 
		\right)^{1/2}
	\end{split}
\end{equation}
...
\begin{split}
  ...
  \int_{\tau_{1}} \chi_{A} \langle | \tau | - n^{2} \rangle ^{-1/2} \phi(n, \tau)
    c_f(n_1, \tau_1)
		c_g(n - n_1, \tau - \tau_1 )
		\\
    & \times \frac{\langle n \rangle ^{s}}{\langle n_{1} \rangle ^{s} \langle
...
\begin{split}
  ...
  n - n_{1}\rangle ^{2s}}  \times \frac{\chi_{A_{j}}}{\langle \sigma \rangle   \langle
...
\begin{equation*}
  \begin{split}
    & 
    \sum_{n \in \zzdot} \int_{\tau} \frac{\chi_{A_{1}}\langle n \rangle ^{2s} }{\langle n_{1} \rangle ^{2s} \langle n-n_{1} \rangle ^{2s} \langle \tau - n^{2} \rangle 
...
\end{split}
  ...
  \begin{equation*}
  \begin{split}
    \sum_{n \in \zzdot} \frac{\langle n_{1}\rangle ^{\gamma(s)-4}}{\langle n \rangle} < \infty, \quad s \ge -1
  \end{split}
  \end{equation*}
  %
  uniformly in $n_{1}$.
...
\begin{equation}
  \begin{split}
    ...
    \langle \tau_{1} - n_{1}^{2} \rangle \langle  \tau - \tau_{1} - (n - n_{1})^{2} \rangle}
    d \tau_1 
    \\
    & \lesssim \sum_{n_{1}} \frac{\langle n - n_{1} \rangle ^{-2s-2} \langle n_{1} \rangle ^{-2s-2}}{\langle
    n\rangle ^{-2s}}  
    \\
    & \lesssim \sum_{n_{1}} \frac{\langle n_{1}\rangle ^{\gamma(s)-4}}{\langle n \rangle} < \infty, \quad s > -3/4
  \end{split}
\end{equation}
  %
...
\begin{equation*}
  \begin{split}
    & \langle n
    \rangle ^{2s}
    \sum_{n_{1}} \int_{\tau_{1}} \frac{\chi_{B_{1}}}{\langle n_{1} \rangle ^{2s} \langle n-n_{1} \rangle ^{2s} 
    \langle \tau_{1} + n_{1}^{2} \rangle \langle  \tau - \tau_{1} -
    (n - n_{1})^{2} \rangle}
    d \tau_1 
    \\
...
For the region $B_{3,2}$ we 
apply a change of variable to obtain
%
%
%
%
...
&  \langle n
    \rangle ^{2s}
    \sum_{n_{1}} \int_{\tau_{1}} \frac{\chi_{B_{3,2}}}{\langle n_{1} \rangle ^{2s} \langle n-n_{1} \rangle ^{2s} 
...
%
%
while for the region $B_{3,3}$, we have
%
%
\begin{equation}
\begin{split}
