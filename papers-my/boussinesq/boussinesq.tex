...
%
%
and so by the pigeonholde principle we may partition
$ A_{4}$ into three (not necessarily disjoint) parts
\begin{align*}
...
\begin{split}
  ...
  \\
&  \lesssim \sum_{n} \frac{\langle n - n_{1} \rangle ^{-2s-2} \langle n_{1} \rangle ^{-2s-2}}{\langle
    n\rangle ^{-2s}}  
  \end{split}
\end{equation}
%
...
\end{split}
  ...
  \begin{equation*}
  \begin{split}
    \sup_{c, n_{1}} \sum_{n} \frac{\langle n_{1}\rangle ^{\gamma(s)-4}}{\langle n_\rangle^{2}} < \infty, \quad s \ge -1
  \end{split}
  \end{equation*}
  %
  %
