...
$| t | \le \delta$.  Lipschitz continuity of the flow map will follow from
estimates used to establish the contraction mapping. 
%
%
%
%
...
%
%
We first note that \cref{main1-rel-term-3} remains unchanged if
we replace $w$  with $w_{\delta} \doteq \psi_{2 \delta} w$. 
We now need the following.
%
\begin{lemma}
...
Again, we can take replace $w$ with $w_{\delta}$ without impunity.
