...
\usepackage[alphabetic, initials, msc-links]{amsrefs} %for the bibliography; uses cite pkg
\usepackage{cleveref}
...
\renewcommand{\qed}{\qquad \qedsymbol} %for the proof environment--qed symbol is flush right otherwise
%
%
\theoremstyle{plain}  
...
%
%
\subsection{Proof of \cref{lem:splitting}.} We have
%
%
\begin{equation}
	\label{6a}
