...
\subsection{The Fourier Transform of $\sech^{2}(x)$.} 
   ...
   \end{equation}
       ...
       % 
        %
        Lastly, using the change of variable $z = t + \pi i$, we have
        %
        %
        \begin{equation}
...
\begin{figure}[!t]
  ...
  \vspace{-30mm}
  \hspace{-15mm}
  \subfloat{\includegraphics[scale=0.5]{sech-ep-1}}
\hspace{-40mm}
\subfloat{\includegraphics[scale=0.5]{sech-ep-01}}
\\
\vspace{-70mm}
\hspace{-15mm}
\subfloat{\includegraphics[scale=0.5]{sech-ep-001}}
\end{center}
\end{figure}
%
%
