...
data-to-solution map for the HR IVP, expanding upon Theorem~\ref{thm:hr-non-unif-dependence}. More precisely, following \cite{Chen:2011fk} we show
...
\end{lemma}
%
An analogous result can be found in \cite{Himonas:2009fk}, and is a simple consequence of Theorem~\ref{thm:HR_existence_continuous_dependence} and the profile of our initial data. Applying the inequality 
%
\begin{equation}
\begin{split}
...
\end{split}
\end{equation*}
continuously. Since $H^{s}$, it follows that the adjoint operator $(T_\varphi P)^{\star}$
exists and
\begin{equation*}
