...
%%%%%%%%%%%%%%%%%%%%%%
%
\subsection{Equicontinuity of $\{u_\ee\}$  in
...
\subsubsection{Estimate of Integral 1.} We can rewrite
%
%
\begin{equation}
\begin{split}
...
%
%
\subsubsection{Estimate of Integral 2.} We can rewrite
%
%
\begin{equation}
\begin{split}
...
%
%
\subsubsection{Estimate of Integral 3.} Applying Cauchy-Schwartz, the 
...
%
%
\subsubsection{Estimate of Integral 4.} Applying Cauchy-Schwartz, the 
...
%%%%%%%%%%%%%%%%%%%%%%
%
\subsection{Equicontinuity of $\{ \varphi P [(u_\ee)^k]\}$  in $C(I,
H^{s-\sigma}(\rr))$}
%
%
...
%
%		
\subsection{Precompactness of $\{\varphi P [(u_\ee(t))^k]\}$ in
$H^{s-\sigma  }(\rr)$}
...
\end{equation}
\end{theorem}
\subsection{Verifying that the $\text{weak}^{\star}$ limit $u$ solves the HR equation} 
...
\end{split}
\end{equation}
Letting $\ee \to 0$ in \eqref{hh2bb} and applying Theorem~\ref{hhthm:crit1} completes
the proof.
\end{proof}
%
%
...
\end{equation}
\end{proposition}
\begin{proof} The result follows from Theorem~\ref{hhthm:crit1}.
...
$J_\ee$. By construction, the proofs of Lemma~\ref{lem5r} and Lemma~\ref{lem4r} for the non-periodic case will be
