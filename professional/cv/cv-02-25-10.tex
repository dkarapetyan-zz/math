...
%
I am currently working in a wide variety of 
fields, including partial differential equations, numerical analysis, 
and financial mathematics. I have recently submitted a 
highly technical paper on the hyperelastic-rod equation, which is a 
generalized version of the Camassa-Holm equation, a famous model for the 
nonlinear evolution of waves. I have since moved into studying generalized 
KDV and NLS equations. In addition, motivated by the work of John Cochrane, 
...
``The Cauchy problem for the Hyperelastic Rod equation'' \\
...
``Non-Uniform Dependence for the Hyperelastic Rod equation''\\ 
