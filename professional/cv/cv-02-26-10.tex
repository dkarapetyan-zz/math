...
%
I am currently working in a variety of fields, including partial differential 
equations, numerical analysis, and financial mathematics. I have recently 
submitted a paper on sharp well-posedness for the hyperelastic-rod equation, a 
famous model for the nonlinear evolution of deformation waves in thin 
cylindrical rods. The proof utilizes the recently developed
method of approximate solutions, as well as a new proof of
local well-posedness. I have since moved into studying local and global 
well-posedness in Sobolev spaces for new modified KDV and NLS equations with higher 
dispersion. Specifically, I am interested in the relationship between the degree of 
dispersion and the lowest Sobolev index for which well-posedness holds.  
In addition, motivated by the work of John Cochrane,
I am also investigating PDEs that arise from asset pricing and utility 
maximization models.
...
for the
Hyperelastic Rod Equation.} \\ Submitted, 2009
...
\item[] Instructor \hfill \textbf{January 2010-present}
...
``Four Classical PDEs'' \\
September 20-December 2, 2008, University of Notre Dame, Indiana \\

\textit{Mathematics Teaching Seminar} \\
``Taylor Approximations'' \\
April 7, 2009, University of Notre Dame, Indiana \\
...
November 23, 2009, University of Notre Dame, Indiana \\
...
%November 5-7, 2010, University of Notre Dame, Indiana 
%
\section{Professional Activities}
\textit{The 4th Symposium on Analysis \& PDEs} \\
May 26-29, 2009, Purdue University, Lafayette, Indiana \\

\textit{AMS Joint Mathematics Meetings} \\
January 13-16, 2010, San Francisco, California \\

\textit{The 8th AIMS Conference on Dynamical Systems, Differential 
