...
famous model for the non-linear evolution of deformation waves in thin 
cylindrical rods. The proof utilizes the recently developed method of 
approximate solutions, as well as a new proof of local well-posedness. I have 
since moved into studying a series of unexplored dispersive equations modeled 
after the KDV and NLS. Specifically, I am interested in the relationship between 
the degree of dispersion and the lowest Sobolev index for which local and global 
well-posedness holds. In addition, motivated by the work of John Cochrane, I am 
also investigating PDEs that arise from asset pricing and utility maximization 
models.
\section{Education}
%
