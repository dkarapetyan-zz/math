...
%
%
\subsubsection{Energy Estimate for \texorpdfstring{$u_\ee$}{u_e}}
%
...
%
\noindent
\subsubsection{Lifespan Estimate for \texorpdfstring{$u_\ee$}{u_e}} To derive an explicit formula for
...
%
\noindent
\subsubsection{Uniform Regularity of the set of \texorpdfstring{$u_{\ee}$}{u_e}} If we choose  $T=\frac12 T_0$, that is
%
\begin{equation} 
\label{T-def}
T
