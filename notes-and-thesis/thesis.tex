...
%\listoftables
 ...
 %% \renewcommand{\acknowledgename}{ } % If you want another Acknowledgement name
  ...
  \begin{acknowledge}
    I would like to thank my advisor Professor Alex Himonas for his support and 
    guidance. I am grateful for his help in procuring the Schmitt
    Presidential Fellowship, which was a great aid in completing my
    doctoral studies. 

    Thanks also to Gerard Misiolek, who was always ready to answer
    the random analysis question or talk about the arts. To Professor Gerson
    Petronilho, for the many talks he has given, and his patience in collaborating
    with a junior mathematician. I am also am indebted to my friend and
    collaborator Professor Dan Geba, who is one of the finest human beings I
    have ever known. He's also not too shabby at tennis. 

    Many thanks to my officemates Yen Huang and Yenrui Hao, who were always willing to discuss mathematics with me when we weren't horsing around. I must also thank Katie Grayshan for her friendship and many useful discussions, which helped me identify and shore up my weaknesses. 

    Thanks to Beth VerVelde, who understood me better than most, and is too wise for her own good. To my friends back home, thanks goes to Cynthia Ramirez, who always felt guilty whenever I was sent to voicemail, and called me back as soon as possible. Your patience and loyalty helped me perservere, and will not be forgotten. To Amelda zemer, your kindnesses and enormous heart have given me the strength to never break, no matter the adversity or general nonsense I may encounter.
    
    Lastly, thanks to my mom, Satenik Antonian, who has always had my best interests at heart, and has never wavered in her support and love.

    %The author thanks the Department of Mathematics at the University of Notre Dame and the Arthur J. Schmitt Foundation for supporting his doctoral studies.
  \end{acknowledge}
