...
%
%
We will now prove well-posedness for HR\@. Since the proof for the circle and the line are similar,
...
\begin{equation*}
\label{equic-2}
\|u_\ee(t) - u_\ee(t') \|_{H^{s - \sigma}(\ci)}< c|t - t'|^\sigma, \ \text{for
    all} \ \,\,  t, t'\in I,
\end{equation*}
%
%
...
\begin{equation}
\label{distib-conv-2}
T_{\p_t u_{\ee_n}}(\phi)  \longrightarrow  T_{\p_t u}(\phi) \; \ \text{for all} \ \;  \phi \in L^1(I, H^{s}(\ci)).
\end{equation}
%
%
%
